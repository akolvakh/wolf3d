...
//libmlx<> + makefile
//проверки на валидацию уровня
//сега на точке, куда я ставлю игрока
//инклудник из фрактола
//формула по ликам
//юнит тесты каждого юнита в отдельности
//текстуры
//пол и потолок
//ускорение
//защита и кейсить ошибки на млх, текстуры, етс
//лики перед выходом и после выхода
//фришить память
//архитектура, модель и полный пайплайн
//порядок в DS - или отдельными структурами, или все в одной простыне
//parser test
